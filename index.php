...
<html>
<head>
	<title>Program Regresi Linier</title>
...
<body>
	<div class="header">
		<div class="header-logo">Program Regresi Linier</div>
	</div>
	<div class="main">
	...
	<table>
		<form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
			...
			<tr>
				...
				<td>:</td>
				<td><input type="text" class="form" name="x" ></td>
			</tr>
			<tr>
				<td colspan="2" ></td>
				<td><input type="submit" class="tombol" name="submit" value="Prediksi"></td>
			</tr>
			<?php
			if (isset($_POST['submit'])) {
				...
				echo '<tr><td colspan="3" class="hasil"><p>Nilai Y hasil prediksi <b> Y = '.$a.' + '.$b.'X = '.$y.'</b></p></td>
				</tr>';
			}
